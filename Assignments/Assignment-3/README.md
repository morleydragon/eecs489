...
### Environment
You will continue working on the virtual image for Assignment 2. Please refer to Assignment 2 spec for the instruction on shared folder and network setting. **DO NOT** update anything in the VM.
